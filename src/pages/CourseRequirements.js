    ...
    <div className={style.container}>
      ...
      <section className={style.paragraph}>
        ...
        <p>
          ...
          <span>I-IV</span>
          will be required. There can be overlap in courses satisfying category
          <span>IV</span>
      ...
      <p className={style.paragraph}>
        All students in the program must satisfy the University’s requirement of
        a minimum of <b>72</b> credits for a PhD. At least <b>30</b> of these
        credits will be satisfied by the core program, including the
      ...
      <p className={style.paragraph}>
        ...
        in one of the three main areas, he/she can counter that with a grade of
        B or above in an additional approved course in that area. If a student
        receives two grades below B, he/she will no longer be able to continue
        in the program. Students who do not meet these requirements but who have
        an overall grade average of B or better, have the option of doing a
        literature-based Master’s Thesis. All Students receiving a Master’s
        degree, must meet the minimum requirement of <b>30</b> credits. This
        includes six courses in areas <span>I-III</span> listed above, and 12
        credits in area <span>IV</span>. Up to six credits can be met in section{" "}
        <span>IV</span> by Thesis Research credits.
      </p>
      <SubHeader headingTitle="Comprehensive Exam" />
      <p className={style.paragraph}>
        The comprehensive exam will be taken by the end of the student’s seventh
        semester at the University of Pittsburgh, and will focus on the progress
        that the student has made to date on his/her research. The comprehensive
        exam will consist of a written report prepared by the student on his/her
        research, followed by an oral examination. The exam will be administered
        by a committee of four faculty members, at least two of whom (including
        the student’s advisor) will be from the Department of the student’s
        concentration, and at least one of whom will be from an outside
        department. If a student does not pass the comprehensive exam, he/she
        will have the option of continuing in the program for another semester,
        completing the minimum required <b> 30</b> credits, and submitting a
        Master’s thesis based on independent research. The student’s committee
      ...
      <section className={style.paragraph}>
        <p>
          ...
          permanent advisor is made with the consent of the faculty member, who
          then agrees to support the student after the first year in the
          program.
        </p>
        <p>
          ...
          to be successful in the core courses that they choose to take. By the
          end of the first year, each participating student will choose a
          four-person Comprehensive Committee, the make-up of which is described
          above.
        </p>
